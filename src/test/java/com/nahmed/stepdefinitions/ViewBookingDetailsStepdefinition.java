...
public class ViewBookingDetailsStepdefinition {
    ...
    public void userMakesARequestToViewBookingIDs() {
        ...
        scenarioState.setData("bookingID", bookingID);
    }
    ...
    public void userMakesARequestToViewDetailsOfBookingID() {
        Integer bookingID = scenarioState.getData("bookingID", Integer.class);
        ...
        scenarioState.setData("firstname", bookingDetails.getFirstname());
        scenarioState.setData("lastname", bookingDetails.getLastname());
    }
    ...
    public void userMakesARequestToViewBookingIDByUserName() {
        String firstname = scenarioState.getData("firstname", String.class);
        String lastname = scenarioState.getData("lastname", String.class);
